...
class UserDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_detail" do
    assert_difference("UserDetail.count") do
      post user_details_url, params: { user_detail: { contact_no: @user_detail.contact_no, first_name: @user_detail.first_name, gender: @user_detail.gender, last_name: @user_detail.last_name, middle_initial: @user_detail.middle_initial, user_id: @user_detail.user_id } }
    end
  ...
  test "should update user_detail" do
    patch user_detail_url(@user_detail), params: { user_detail: { contact_no: @user_detail.contact_no, first_name: @user_detail.first_name, gender: @user_detail.gender, last_name: @user_detail.last_name, middle_initial: @user_detail.middle_initial, user_id: @user_detail.user_id } }
