...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference("Batch.count") do
      post batches_url, params: { batch: { description: @batch.description, title: @batch.title } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { description: @batch.description, title: @batch.title } }
